...
/-! Early-warning gradients. Source: Eagle/features.py.
...
def baseComponents : List String := ["out['gradient_loss']", "out['snapshot_anomaly']", "out['gradient_disagreement']", "out['gradient_acceleration']"]
def horizonComponents : List String := ["out[f'loss_mean_{h}']", "out[f'loss_slope_{h}'].clip(lower=0)", "out[f'anomaly_mean_{h}']", "out[f'disagreement_mean_{h}']"]
