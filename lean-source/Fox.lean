...
/-! Feedback oscillation. Source: Fox/features.py.
...
def baseComponents : List String := ["out['feedback_gain_proxy']", "out['feedback_peak']", "out['feedback_dispersion']", "out['oscillation_amplitude']", "out['damping_loss']", "out['overshoot']"]
def horizonComponents : List String := ["out[f'gain_mean_{h}']", "out[f'osc_mean_{h}']", "out[f'damping_mean_{h}']", "out[f'overshoot_mean_{h}']"]
